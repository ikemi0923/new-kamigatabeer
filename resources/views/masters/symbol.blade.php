...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="fOzCwVec0oiTyHH61IocNjd4amrx0DkiaN54ZzLk">
    ...
    <div id="app">
                            ...
                            <div aria-labelledby="navbarDropdown" class="dropdown-menu dropdown-menu-right"><a
                                ...
                                <form id="logout-form" action="https://alfha.mountain-gorilla.co.jp/logout"
                                    method="POST" style="display: none;"><input type="hidden" name="_token"
                                        value="fOzCwVec0oiTyHH61IocNjd4amrx0DkiaN54ZzLk"></form>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <main class="py-4">
            <div class="container-fluid">
                <!---->
                <div data-v-2e74cd96="" class="container">
                    <div data-v-2e74cd96="" class="d-flex justify-content-start mb-3">
                        <div data-v-2e74cd96="" class="mr-auto"><span data-v-2e74cd96="" class="span-header">記号一覧</span>
                        </div>
                        <div data-v-2e74cd96="" class="align-self-center mr-3"><button data-v-2e74cd96="" type="button"
                                class="btn btn-primary"><i data-v-2e74cd96="" class="fas fa-plus"></i> 新規追加</button>
                        </div>
                        <div data-v-2e74cd96="" class="align-self-center"><button data-v-2e74cd96="" type="button"
                                class="btn btn-dark">戻る</button></div>
                    </div>
                    <table data-v-2e74cd96="" class="table table-sm table-striped">
                        <thead data-v-2e74cd96="">
                            <tr data-v-2e74cd96="">
                                <th data-v-2e74cd96="" scope="col" class="text-center">名称</th>
                                <th data-v-2e74cd96="" scope="col" class="text-center">銘柄</th>
                                <th data-v-2e74cd96="" scope="col" class="text-center">品目</th>
                                <th data-v-2e74cd96="" scope="col" class="text-center">店舗</th>
                            </tr>
                        </thead>
                        <tbody data-v-2e74cd96="" class="bg-white">
                            <tr data-v-2e74cd96="" class="clickable">
                                <td data-v-2e74cd96="" class="text-center align-middle">
                                    スピンコースター
                                </td>
                                <td data-v-2e74cd96="" class="text-center align-middle">
                                    アンバーエール
