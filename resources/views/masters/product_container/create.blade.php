          ...
          <div data-v-793490ba="" class="row justify-content-center">
            <div data-v-793490ba="" class="col-md-8">
              ...
              <form data-v-793490ba="" method="post" name="form1" action="">
                ...
                <div data-v-793490ba="" class="form-group row">
                  <label data-v-793490ba="" for="capacity" class="col-sm-4 col-form-label text-md-right">
                    容量
                  </label>
                  <div data-v-793490ba="" class="col-md-6">
                    <input data-v-793490ba="" type="text" name="capacity" id="capacityr" class="form-control" value="{{ old('capacity') }}">
                  </div>
                </div>
