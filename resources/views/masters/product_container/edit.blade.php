                        ...
                        <div data-v-793490ba="" class="col-md-8">
                            <div data-v-793490ba="" class="d-flex justify-content-start mb-3">
                                <div data-v-793490ba="" class="mr-auto">
                                    <span data-v-793490ba="" class="span-header">製品・容器の編集
                                    </span>
                                </div>
                            ...
                            <form data-v-793490ba="" method="post" name="form1" action="/masters/product_containers/finish">
                                @csrf
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="name" id="name" class="form-control"
                                            value="{{$product_containers->name}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="capacity"
                                        class="col-sm-4 col-form-label text-md-right">容量
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="capacity" id="capacity"
                                            class="form-control" value="{{$product_containers->capacity}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="form1" id="is_visibled"
                                            class="custom-control-input" value="{{$product_containers->is_visibled}}">
                            ...
                            <div data-v-793490ba="" class="d-flex justify-content-start mt-5">
                                <div data-v-793490ba="" class="align-self-center mr-auto">
                                    <a href="/masters/hops/delete/{{$product_containers->id}}/"><button data-v-793490ba=""
                                            type="button" class="btn btn-outline-danger">この製品・容器を削除
                                        </button></a>
                                </div>
                            </div>
                        </div>
