                ...
                <div data-v-793490ba="" class="container">
                    <div data-v-793490ba="" class="row justify-content-center">
                        <div data-v-793490ba="" class="col-md-8">
                            ...
                            <form data-v-793490ba="" method="post" name="form1" action="/masters/basic_informations/add">
                                @csrf
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_name" class="col-sm-4 col-form-label text-md-right">
                                        名称
                                    </label>
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_code" class="col-sm-4 col-form-label text-md-right">
                                        郵便番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="office_code" id="office_code"
                                            class="form-control" value="{{ old('office_code') }}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_address" class="col-sm-4 col-form-label text-md-right">
                                        住所
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_phone_number" class="col-sm-4 col-form-label text-md-right">
                                        電話番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="representative_name" class="col-sm-4 col-form-label text-md-right">
                                        代表者氏名
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_name" class="col-sm-4 col-form-label text-md-right">
                                        名称
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_code" class="col-sm-4 col-form-label text-md-right">
                                        郵便番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_address" class="col-sm-4 col-form-label text-md-right">
                                        住所
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_phone_number" class="col-sm-4 col-form-label text-md-right">
                                        電話番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="factory_phone_number" id="factory_phone_number" class="form-control"
                                            value="{{ old('factory_phone_number') }}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="tax_office" class="col-sm-4 col-form-label text-md-right">
                                        税務署
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="tax_accountant" class="col-sm-4 col-form-label text-md-right">
                                        税理士
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="tax_accountant" id="tax_accountant" class="form-control"
                                            value="{{ old('tax_accountant') }}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="tax_phone_number" class="col-sm-4 col-form-label text-md-right">
                                        電話番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="tax_phone_number" id="tax_phone_number" class="form-control"
                                            value="{{ old('tax_phone_number') }}">
                                    </div>
                                </div>
                                ...
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="thirty_flg" id="thirty_flg"
                                            class="custom-control-input" value="{{ old('thirty_flg') }}">
                                ...
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="thirty_three_flg" id="thirty_three_flg"
                                            class="custom-control-input" value="{{ old('thirty_three_flg') }}">
                                ...
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="special_adaptation_manufacturer_fl" id="special_adaptation_manufacturer_flg"
                                            class="custom-control-input" value="{{ old('special_adaptation_manufacturer_flg') }}">
