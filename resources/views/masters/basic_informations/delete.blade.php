                ...
                <div data-v-793490ba="" class="container">
                    <div data-v-793490ba="" class="row justify-content-center">
                        <div data-v-793490ba="" class="col-md-8">
                            ...
                            <form data-v-793490ba="" method="post" name="form1"
                                action="/masters/basic_informations/finish">
                                @csrf
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="office_name" id="office_name" class="form-control"
                                            value="{{$basic_information->office_name}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="office_address" id="office_address"
                                            class="form-control" value="{{$basic_information->office_address}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="office_phone_number" id="office_phone_number"
                                            class="form-control" value="{{$basic_information->office_phone_number}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="representative_name" id="representative_name"
                                            class="form-control" value="{{$basic_information->representative_name}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="factory_name" id="factory_name"
                                            class="form-control" value="{{$basic_information->factory_name}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="factory_code" id="factory_code"
                                            class="form-control" value="{{$basic_information->factory_code}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="factory_address" id="factory_address"
                                            class="form-control" value="{{$basic_information->factory_address}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="factory_phone_number" id="factory_phone_number"
                                            class="form-control" value="{{$basic_information->factory_phone_number}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="tax_office" id="tax_office"
                                            class="form-control" value="{{$basic_information->tax_office}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="tax_accountant" id="tax_accountant"
                                            class="form-control" value="{{$basic_information->tax_accountant}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="tax_phone_number" id="tax_phone_number"
                                            class="form-control" value="{{$basic_information->tax_phone_number}}">
                                    </div>
                                </div>
                                ...
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="special_adaptation_manufacturer_flg" id="special_adaptation_manufacturer_flg"
                                            class="custom-control-input" value="{{$basic_information->special_adaptation_manufacturer_flg}}">
                            ...
                            <div data-v-793490ba="" class="d-flex justify-content-start mt-5">
                                <div data-v-793490ba="" class="align-self-center mr-auto">
                                    <button data-v-793490ba="" type="button" class="btn btn-outline-danger">この基本情報を削除
                                    </button>
                                </div>
                            </div>
                        </div>
