                        ...
                        <div data-v-793490ba="" class="col-md-8">
                            <div data-v-793490ba="" class="d-flex justify-content-start mb-3">
                                <div data-v-793490ba="" class="mr-auto">
                                    <span data-v-793490ba="" class="span-header">基本情報の編集
                                    </span>
                                </div>
                            ...
                            <form data-v-793490ba="" method="post" name="form1" action="/masters/basic_informations/finish">
                                @csrf
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_name"
                                        class="col-sm-4 col-form-label text-md-right">名称
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="office_name" id="office_name"
                                            class="form-control" value="{{$basic_information->office_name}}">
                                    </div>
                                </div>

                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_code"
                                        class="col-sm-4 col-form-label text-md-right">郵便番号

                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="office_code" id="office_code"
                                            class="form-control" value="{{$basic_information->office_code}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_address"
                                        class="col-sm-4 col-form-label text-md-right">住所
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="office_address" id="office_address" class="form-control"
                                            value="{{$basic_information->office_address}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="office_phone_number"
                                        class="col-sm-4 col-form-label text-md-right">電話番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="office_phone_number" id="office_phone_number" class="form-control"
                                            value="{{$basic_information->office_phone_number}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="representative_name"
                                        class="col-sm-4 col-form-label text-md-right">代表者氏名
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="representative_name" id="representative_name" class="form-control"
                                            value="{{$basic_information->representative_name}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_name"
                                        class="col-sm-4 col-form-label text-md-right">名称
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="factory_name" id="factory_name" class="form-control"
                                            value="{{$basic_information->factory_name}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_code"
                                        class="col-sm-4 col-form-label text-md-right">郵便番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="factory_code" id="factory_code" class="form-control"
                                            value="{{$basic_information->factory_code}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_address"
                                        class="col-sm-4 col-form-label text-md-right">住所
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="factory_address" id="factory_address" class="form-control"
                                            value="{{$basic_information->factory_address}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="factory_phone_number"
                                        class="col-sm-4 col-form-label text-md-right">電話番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="factory_phone_number" id="factory_phone_number" class="form-control"
                                            value="{{$basic_information->factory_phone_number}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="tax_office"
                                        class="col-sm-4 col-form-label text-md-right">税務署
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="tax_office" id="tax_office" class="form-control"
                                            value="{{$basic_information->tax_office}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="tax_accountant"
                                        class="col-sm-4 col-form-label text-md-right">税理士
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="tax_accountant" id="tax_accountant" class="form-control"
                                            value="{{$basic_information->tax_accountant}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="tax_phone_number"
                                        class="col-sm-4 col-form-label text-md-right">>電話番号
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="tax_phone_number" id="tax_phone_number" class="form-control"
                                            value="{{$basic_information->tax_phone_number}}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="thirty_flg" id="thirty_flg"
                                            class="custom-control-input" value="{{$basic_information->thirty_flg}}">
                                        <label data-v-793490ba="" for="thirty_flg"
                                            class="custom-control-label align-left">税理士法第３０条の書面提出有
                                        </label>
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox" name="thirty_three_flg" id="thirty_three_flg"
                                            class="custom-control-input" value="{{$basic_information->thirty_three_flg}}">
                                        <label data-v-793490ba="" for="thirty_three_flg"
                                            class="custom-control-label align-left">税理士法第33条の2の書面提出有
                                        </label>
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                                    <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                                        <input data-v-793490ba="" type="checkbox"
                                            name="special_adaptation_manufacturer_flg"
                                            id="special_adaptation_manufacturer_flg" class="custom-control-input"
                                            value="{{$basic_information->special_adaptation_manufacturer_flg}}">
                                        <label data-v-793490ba="" for="special_adaptation_manufacturer_flg"
                                            class="custom-control-label align-left">特例適応製造者
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div data-v-793490ba="" class="d-flex justify-content-start mt-5">
                                <div data-v-793490ba="" class="align-self-center mr-auto">
                                    <a href="/masters/basic_informations/delete/{{$basic_information->id}}/"><button
                                            data-v-793490ba="" type="button" class="btn btn-outline-danger">この基本情報を削除
                                        </button></a>
                                </div>
                            </div>
                        </div>
