...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="83zcOAQ5Tb0OgY0dmxp9AKAFBk6o3fBVv9w4iTm5">
    ...
    <div id="app">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown"><a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div aria-labelledby="navbarDropdown" class="dropdown-menu dropdown-menu-right"><a data-v-2e051a20="" class="dropdown-item" style="cursor: pointer;">logout</a>
                                <form id="logout-form" action="https://alfha.mountain-gorilla.co.jp/logout" method="POST" style="display: none;"><input type="hidden" name="_token" value="83zcOAQ5Tb0OgY0dmxp9AKAFBk6o3fBVv9w4iTm5"></form>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <main class="py-4">
            <div class="container-fluid">
                <!---->
                <div data-v-1cc8d0cc="" class="container">
                    <div data-v-1cc8d0cc="" class="d-flex justify-content-start mb-3">
                        <div data-v-1cc8d0cc="" class="mr-auto"><span data-v-1cc8d0cc="" class="span-header">副原料一覧</span></div>
                        <div data-v-1cc8d0cc="" class="align-self-center mr-3"><button data-v-1cc8d0cc="" type="button" class="btn btn-primary"><i data-v-1cc8d0cc="" class="fas fa-plus"></i> 新規追加</button></div>
                        <div data-v-1cc8d0cc="" class="align-self-center"><button data-v-1cc8d0cc="" type="button" class="btn btn-dark">戻る</button></div>
                    </div>
                    <table data-v-1cc8d0cc="" class="table table-sm table-striped">
                        <thead data-v-1cc8d0cc="">
                            <tr data-v-1cc8d0cc="">
                                <th data-v-1cc8d0cc="" scope="col" class="text-center">名前</th>
                                <th data-v-1cc8d0cc="" scope="col" class="text-center">メーカー</th>
                                <th data-v-1cc8d0cc="" scope="col" class="text-center">表示</th>
                            </tr>
                        </thead>
                        <tbody data-v-1cc8d0cc="" class="bg-white">
                            <tr data-v-1cc8d0cc="" class="clickable">
                                <td data-v-1cc8d0cc="" class="text-center align-middle">
                                    カラギナン
                                </td>
                                <td data-v-1cc8d0cc="" class="text-center align-middle">
                                    アマゾン
                                </td>
                                <td data-v-1cc8d0cc="" class="text-center align-middle"><i data-v-1cc8d0cc="" class="fas fa-check"></i></td>
                            </tr>
                            <tr data-v-1cc8d0cc="" class="clickable">
                                <td data-v-1cc8d0cc="" class="text-center align-middle">
                                    koppaklear
