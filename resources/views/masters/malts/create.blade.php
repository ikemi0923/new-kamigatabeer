          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div aria-labelledby="navbarDropdown" class="dropdown-menu dropdown-menu-right">
                ...
                <form id="logout-form" action="https://alfha.mountain-gorilla.co.jp/logout" method="POST"
                  style="display: none;">
            ...
            <div data-v-793490ba="" class="col-md-8">
              <div data-v-793490ba="" class="d-flex justify-content-start mb-3">
                ...
                <div data-v-793490ba="" class="align-self-center mr-2">
                  <form>
                    <button data-v-793490ba="" type="button" class="btn btn-primary" style="width: 10rem;">
              ...
              <form data-v-793490ba="" method="post" name="form1" action="/masters/malts/add">
                @csrf
                <div data-v-793490ba="" class="form-group row">
                  ...
                  <div data-v-793490ba="" class="col-md-6">
                    <input data-v-793490ba="" type="text" name="name" id="name" class="form-control" value="{{ old('name') }}">
                  </div>
                </div>
                <div data-v-793490ba="" class="form-group row">
                  <label data-v-793490ba="" for="maker" class="col-sm-4 col-form-label text-md-right">
                    メーカー
                  </label>
                  <div data-v-793490ba="" class="col-md-6">
                    <input data-v-793490ba="" type="text" name="maker" id="maker" class="form-control" value="{{ old('maker') }}">
                  </div>
                </div>
                <div data-v-793490ba="" class="form-group row">
                  <label data-v-793490ba="" for="ppg" class="col-sm-4 col-form-label text-md-right">
                    PPG
                  </label>
                  <div data-v-793490ba="" class="col-md-6">
                    <input data-v-793490ba="" type="number" name="ppg" id="ppg" class="form-control" value="{{ old('ppg') }}">
                  </div>
                </div>
                <div data-v-793490ba="" class="form-group row">
                  <label data-v-793490ba="" for="color" class="col-sm-4 col-form-label text-md-right">
                    色度
                  </label>
                  <div data-v-793490ba="" class="col-md-6">
                    <input data-v-793490ba="" type="number" name="color" id="color" class="form-control" value="{{ old('color') }}">
                  </div>
                </div>
                <div data-v-793490ba="" class="d-flex justify-content-center mt-3">
                  <div data-v-793490ba="" class="text-center custom-control custom-checkbox">
                    ...
                    <label data-v-793490ba="" for="is_visibled" class="custom-control-label align-left">
                      表示する
                    </label>
                  </div>
                </div>
