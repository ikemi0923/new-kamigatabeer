...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="3rCxK3ndbLAnD6aEfo0ynqTanR868h6ZLFXGD6ju">
    ...
    <div id="app">
                            ...
                            <div aria-labelledby="navbarDropdown" class="dropdown-menu dropdown-menu-right"><a
                                ...
                                <form id="logout-form" action="https://alfha.mountain-gorilla.co.jp/logout"
                                    method="POST" style="display: none;"><input type="hidden" name="_token"
                                        value="3rCxK3ndbLAnD6aEfo0ynqTanR868h6ZLFXGD6ju"></form>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <main class="py-4">
            <div class="container-fluid">
                <!---->
                <div data-v-c6d59778="" class="container">
                    <div data-v-c6d59778="" class="d-flex justify-content-start mb-3">
                        <div data-v-c6d59778="" class="mr-auto"><span data-v-c6d59778="" class="span-header">店舗一覧</span>
                        </div>
                        <div data-v-c6d59778="" class="align-self-center mr-3"><button data-v-c6d59778="" type="button"
                                class="btn btn-primary"><i data-v-c6d59778="" class="fas fa-plus"></i> 新規追加</button>
                        </div>
                        <div data-v-c6d59778="" class="align-self-center"><button data-v-c6d59778="" type="button"
                                class="btn btn-dark">戻る</button></div>
                    </div>
                    <table data-v-c6d59778="" class="table table-sm table-striped">
                        <thead data-v-c6d59778="">
                            <tr data-v-c6d59778="">
                                <th data-v-c6d59778="" scope="col" class="text-center">名称</th>
                            </tr>
                        </thead>
                        <tbody data-v-c6d59778="" class="bg-white">
                            <tr data-v-c6d59778="" class="clickable">
                                <td data-v-c6d59778="" class="text-center align-middle">
                                    上方ビール
                                </td>
                            </tr>
                        </tbody>
