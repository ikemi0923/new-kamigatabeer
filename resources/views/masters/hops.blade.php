    ...
    <div id="app">
                            ...
                            <div aria-labelledby="navbarDropdown" class="dropdown-menu dropdown-menu-right"><a
                                ...
                                <form id="logout-form" action="https://alfha.mountain-gorilla.co.jp/logout"
                                    method="POST" style="display: none;"><input type="hidden" name="_token"
                                        value="V701dcfNuNLnWyja6oQOkI0PqQFZoj54grqyhUL8"></form>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <main class="py-4">
            <div class="container-fluid">
                <!---->
                <div data-v-68add828="" class="container">
                    <div data-v-68add828="" class="d-flex justify-content-start mb-3">
                        <div data-v-68add828="" class="mr-auto"><span data-v-68add828=""
                                class="span-header">ホップ一覧</span></div>
                        <div data-v-68add828="" class="align-self-center mr-3"><button data-v-68add828="" type="button"
                                class="btn btn-primary"><i data-v-68add828="" class="fas fa-plus"></i> 新規追加</button>
                        </div>
                        <div data-v-68add828="" class="align-self-center"><button data-v-68add828="" type="button"
                                class="btn btn-dark">戻る</button></div>
                    </div>
                    <table data-v-68add828="" class="table table-sm table-striped">
                        <thead data-v-68add828="">
                            <tr data-v-68add828="">
                                <th data-v-68add828="" scope="col" class="text-center">名前</th>
                                <th data-v-68add828="" scope="col" class="text-center">メーカー</th>
                                <th data-v-68add828="" scope="col" class="text-center">α酸(%)</th>
                                <th data-v-68add828="" scope="col" class="text-center">表示</th>
                            </tr>
                        </thead>
                        <tbody data-v-68add828="" class="bg-white">
                          @foreach ($hops as $hops)
                          <tr data-v-8e84c29e="" class="clickable">
                            <td data-v-8e84c29e="" class="text-center align-middle">{{ $hops->name }}</td>
                            <td data-v-8e84c29e="" class="text-center align-middle">{{ $hops->maker }}</td>
                            <td data-v-8e84c29e="" class="text-center align-middle">{{ $hops->alpha }}</td>
                            <td data-v-8e84c29e="" class="text-center align-middle">{{ $hops->hops_display_flg }}
