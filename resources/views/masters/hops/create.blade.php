                ...
                <div data-v-793490ba="" class="container">
                    <div data-v-793490ba="" class="row justify-content-center">
                        <div data-v-793490ba="" class="col-md-8">
                            ...
                            <form data-v-793490ba="" method="post" name="form1" action="/masters/hops/add">
                                @csrf
                                ...
                                <div data-v-793490ba="" class="form-group row">
                                    ...
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="text" name="maker" id="maker"
                                            class="form-control" value="{{ old('maker') }}">
                                    </div>
                                </div>
                                <div data-v-793490ba="" class="form-group row">
                                    <label data-v-793490ba="" for="alpha" class="col-sm-4 col-form-label text-md-right">
                                        α酸(%)
                                    </label>
                                    <div data-v-793490ba="" class="col-md-6">
                                        <input data-v-793490ba="" type="number" name="alpha" id="alpha"
                                            class="form-control" value="{{ old('alpha') }}">
                                    </div>
                                </div>
