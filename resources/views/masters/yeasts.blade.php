    ...
    <div id="app">
        ...
        <main class="py-4">
            <div class="container-fluid">
                <!---->
                <div data-v-a07f8ffc="" class="container">
                    <div data-v-a07f8ffc="" class="d-flex justify-content-start mb-3">
                        <div data-v-a07f8ffc="" class="mr-auto"><span data-v-a07f8ffc="" class="span-header">酵母一覧</span>
                        </div>
                        <div data-v-a07f8ffc="" class="align-self-center mr-3"><button data-v-a07f8ffc="" type="button"
                                class="btn btn-primary"><i data-v-a07f8ffc="" class="fas fa-plus"></i> 新規追加</button>
                        </div>
                        <div data-v-a07f8ffc="" class="align-self-center"><button data-v-a07f8ffc="" type="button"
                                class="btn btn-dark">戻る</button></div>
                    </div>
                    <table data-v-a07f8ffc="" class="table table-sm table-striped">
                        <thead data-v-a07f8ffc="">
                            <tr data-v-a07f8ffc="">
                                <th data-v-a07f8ffc="" scope="col" class="text-center">名前</th>
                                <th data-v-a07f8ffc="" scope="col" class="text-center">メーカー</th>
                                <th data-v-a07f8ffc="" scope="col" class="text-center">表示</th>
                            </tr>
                        </thead>
                        <tbody data-v-a07f8ffc="" class="bg-white">
                            <tr data-v-a07f8ffc="" class="clickable">
                                <td data-v-a07f8ffc="" class="text-center align-middle">
                                    BRY-97
                                </td>
                                <td data-v-a07f8ffc="" class="text-center align-middle">
                                    Lallemand
                                </td>
                                <td data-v-a07f8ffc="" class="text-center align-middle"><i data-v-a07f8ffc=""
