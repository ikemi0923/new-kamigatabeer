...
class StoreController extends Controller
{
    ...
    {
        $stores = Stores::all();
        return view('masters.stores', ['stores' => $stores]);
    }

    function show()
    {
        $stores = Stores::all();
        return view('masters.stores.create', ['stores' => $stores]);
    }
    ...
    public function add(Request $request)
    {
        ...
        $stores = Validator::make($request->all(), $rules, $message);
        if ($stores->fails()) {
            return redirect('/masters/stores/create')
                ->withErrors($stores)
                ->withInput();
        } else {
            $post = new Stores();
            ...
            $post->save();
            return view('masters.stores.create', ['msg' => '正しく入力されました']);
        }
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('masters.stores.edit', ['stores' =>  $store]);
    }
    ...
    public function finish($id, Request $request)
    {
        ...
        $store = Validator::make($request->all(), $rules, $message);
        if ($store->fails()) {
            return redirect('masters.stores.create')
                ->withErrors($store)
                ->withInput();
        } else {
            $basic_information = Stores::findOrFail($id);
